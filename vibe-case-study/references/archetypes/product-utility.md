...
- **AI Collaboration** — only where the source specifies the initial output, concrete mismatch, author intervention, and changed result. Otherwise keep the correction as a missing-evidence question rather than an article lesson.
